...
export class ChargersService {
  ...
  geoCodingUrl =
    "https://maps.googleapis.com/maps/api/geocode/json?addres=YOUR_ADDRESS&key=YOUR_API_KEY";

  url =
    "https://sedeaplicaciones.minetur.gob.es/Greco/DatosRISP.aspx?fichero=exportarcsv";
